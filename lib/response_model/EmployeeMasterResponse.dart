...
EmployeeMasterResponse employeeMasterFromJson(String str) => EmployeeMasterResponse.fromJson(json.decode(str));

String employeeMasterToJson(EmployeeMasterResponse data) => json.encode(data.toJson());
...
class EmployeeMasterResponse {
  ...
  factory EmployeeMasterResponse.fromJson(Map<String, dynamic> json) => new EmployeeMasterResponse(
    status: json["status"],
    message: json["message"],
    data: new List<EmployeeMasterModel>.from(json["data"].map((x) => EmployeeMasterModel.fromJson(x))),
  );
...
class EmployeeMasterModel {
  ...
  factory EmployeeMasterModel.fromJson(Map<String, dynamic> json) => new EmployeeMasterModel(
    no: json["No_"],
